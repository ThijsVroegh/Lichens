...
def plot_red_list_pie_chart(result_df, red_list_df):
    ...
    fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(15, 8),
                                   gridspec_kw={'width_ratios': [1.25, 0.75], 'wspace': 0.02})
    ...
    # Save the plot
    plt.savefig('plots/red_list_distribution.jpg', dpi=300, bbox_inches='tight')
    plt.close()

    print(f"Red list distribution plot created and saved in plots/red_list_distribution.jpg")
...
def plot_red_list_status_pie_chart(red_list_df):
    ...
    # Save the plot
    plt.savefig('plots/red_list_status.jpg', dpi=300, bbox_inches='tight')
    plt.close()

    print(f"Red list status plot created and saved in plots/red_list_status.jpg")
...
def plot_red_list_distribution_horizontal(result_df):
    ...
    # Save the plot
    plt.savefig('plots/red_list_horizontal.jpg', dpi=300, bbox_inches='tight')
    plt.close()

    print(f"Horizontal red list distribution plot created and saved in plots/red_list_horizontal.jpg")
